<?php get_header( );?>
        ...
        <div class="meeta-hero-section" style="background-image: url(<?php echo get_template_directory_uri().'/assets/images/slider-1.jpg'?>);">

            <img class="hero-shape-01" src="<?php echo get_template_directory_uri(  ).'/assets/images/shape/shape-1.svg'?>" alt="shpae">
            <img class="hero-shape-02" src="<?php echo get_template_directory_uri(  ).'/assets/images/shape/shape-2.png'?>" alt="shpae">
